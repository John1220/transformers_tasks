...
parser.add_argument("--train_path", default="data/DuIE/train.txt", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="data/DuIE/dev.txt", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="./checkpoint/DuIE", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--max_seq_len", default=256, type=int,help="The maximum total input sequence length after tokenization. Sequences longer "
...
parser.add_argument("--auto_da_epoch", default=2, type=int, required=False, help="auto add positive/negative samples policy frequency.")
...
parser.add_argument("--img_log_name", default='UIE Base', type=str, help="Logging image file name.")
