...
parser.add_argument("--p_embedding_num", type=int, default=15, help="number of p-embedding")
parser.add_argument("--max_label_len", type=int, default=2, help="max length of label")
