...
parser.add_argument("--model", default='/opt/data02/zhan/text-similarity/data/ch/bert/albert_chinese_small', type=str, help="backbone of encoder.")
...
parser.add_argument("--save_dir", default="checkpoints/comment_classify/", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
...
parser.add_argument("--valid_steps", default=20, type=int, required=False, help="evaluate frequecny.")
parser.add_argument("--logging_steps", default=5, type=int, help="log interval.")
parser.add_argument('--device', default="cuda:0", help="Select which device to train model, defaults to gpu.")
parser.add_argument("--max_label_len", default=2, type=int, help="max length of label")
parser.add_argument("--rdrop_coef", default=5e-2, type=float, help="The coefficient of KL-Divergence loss in R-Drop paper, for more detail please refer to https://arxiv.org/abs/2106.14448), if rdrop_coef > 0 then R-Drop works")
parser.add_argument("--img_log_dir", default='logs/comment_classify', type=str, help="Logging image path.")
parser.add_argument("--img_log_name", default='BERT', type=str, help="Logging image file name.")
parser.add_argument("--verbalizer", default='data/comment_classify/verbalizer.txt', type=str, help="verbalizer file.")
parser.add_argument("--prompt_file", default='data/comment_classify/prompt.txt', type=str, help="prompt file.")
