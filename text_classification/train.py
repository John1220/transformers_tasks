...
parser.add_argument("--model", default='uer/chinese_roberta_L-8_H-512', type=str, help="backbone of encoder.")
parser.add_argument("--train_path", default="data/intention/train.txt", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="data/intention/dev.txt", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="checkpoints/intention", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
...
parser.add_argument("--img_log_name", default='intention', type=str, help="Logging image file name.")
