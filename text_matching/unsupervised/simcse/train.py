...
parser.add_argument("--train_path", default="data/LCQMC/train.txt", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="data/LCQMC/dev.tsv", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="checkpoints/LCQMC", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--max_seq_len", default=64, type=int,help="The maximum total input sequence length after tokenization. Sequences longer "
    "than this will be truncated, sequences shorter will be padded.", )
parser.add_argument("--batch_size", default=64*2, type=int, help="Batch size per GPU/CPU for training.", )
...
parser.add_argument("--valid_steps", default=800, type=int, required=False, help="evaluate frequecny.")
parser.add_argument("--logging_steps", default=50, type=int, help="log interval.")
parser.add_argument("--img_log_dir", default='logs/LCQMC', type=str, help="Logging image path.")
parser.add_argument("--img_log_name", default='albert-ESimCSE', type=str, help="Logging image file name.")
