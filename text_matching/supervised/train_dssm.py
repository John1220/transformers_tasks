...
from transformers import AutoTokenizer, AutoModel, default_data_collator, get_scheduler, BertModel
...
parser.add_argument("--dev_path", default="data/LCQMC/dev.txt", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="checkpoints/comment_classify/dssm", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
...
parser.add_argument("--img_log_name", default='DSSM', type=str, help="Logging image file name.")
