...
parser.add_argument("--save_dir", default="checkpoints/comment_classify/sentence_transformer", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
...
parser.add_argument("--img_log_name", default='Sentence-bert', type=str, help="Logging image file name.")
